...
public:
    ...
    double ti, tu;
    int n, stat, nnet;
    char *infile[6+MNNET-1], outfile[1024];
    char *rov, *base;

    explicit ProcessingThread(QObject *parent, int nneta);
    ~ProcessingThread();
...
private:
    ...
    void ReadNetList(QSettings *ini, const QString &key, int i);
    void ReadNetListHist(QSettings *ini, const QString &key, int i);
    void ReadBaselineConst(QSettings *ini, const QString &key);
    void WriteList(QSettings *ini, const QString &key, const QComboBox *combo);
    void WriteNetList(QSettings *ini, const QString &key, int i);
    void WriteNetListHist(QSettings *ini, const QString &key, int i);
...
public:
    ...
    int OutputHeight, OutputGeoid, DebugTrace, DebugStatus, BaseLineConst[MNNET];
    ...
    double RovPos[3], RefPos[MNNET*3], BaseLine[MNNET*2];
    double MaxSolStd;
	snrmask_t SnrMask;
	exterr_t ExtErr;
    ...
    QVector< QVector< QString > > NetFiles;
